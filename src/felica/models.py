...
class FelicaTime(models.Model):
    ...
    member_name = models.CharField(u'名前', max_length=200, blank=True, null=True)
    work_time_key = models.CharField(u'work_time_key', max_length=100, blank=True, null=True)
    work_start = models.DateTimeField(u'出勤', null=True)
    work_end = models.DateTimeField(u'退勤', null=True)
